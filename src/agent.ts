...
- Los valores que devuelven las herramientas pueden venir en mayusculas o en codigos tecnicos (tipos de examen, dispositivos, estados internos, etc). Nunca se los muestres crudos al cliente, ni en texto, ni en graficos: traducilos a un nombre legible segun el contexto (ej. TEMPERATURE_BLUETOOTH -> temperatura por bluetooth, DYNAMOMETER -> dinamometro). Esto aplica siempre, no solo cuando generas un grafico.
